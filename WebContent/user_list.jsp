...
<body>
	...
	<script type="text/javascript">
		layui.use('table', function() {
			...
			table.render({
			    elem: '#test'
			    ,url:'${path}/user/selectByPage.action'
			...
			//监听工具条
			 table.on('tool(tableFilter)', function(obj){
			  ...
			  $('#insert').on('click', function() {
				  console.log('insert');
				  // location.href='${path}/user_insert.jsp';
				  layer.open({
					  type : 2,
					  area : ['500px', '400px'],
					  content : '${path}/user/getUserInsertPage.action'
				  });
			  });
